          ...
          <Card className="shadow-xl dark:shadow-2xl border-0 bg-white dark:bg-gray-800 backdrop-blur-sm">
            ...
            <CardContent className="px-4 sm:px-6">
              ...
              >
                ...
                <Button
                  type="submit"
                  className="w-full cursor-pointer dark:bg-[#15D3E0] hover:bg-[#13c4d1] text-white dark:text-black font-semibold py-3 sm:py-4 rounded-lg shadow-lg hover:shadow-xl hover:scale-[1.02] h-12 sm:h-14"
                >
              ...
              <CardContent className="px-4 sm:px-6">
                <div className="flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:space-x-4">
                  <Button
                    ...
                    size="lg"
                    asChild
                    className="flex-1 py-1 border-[#15D3E0]/30 hover:border-[#15D3E0] hover:bg-[#15D3E0]/10   dark:bg-slate-800 dark:border-gray-700 dark:hover:bg-gray-700 h-12 sm:h-auto"
                  >
                    <a
