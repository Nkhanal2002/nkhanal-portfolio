          ...
          <Card className="shadow-xl dark:shadow-2xl border-0 bg-white dark:bg-gray-800 backdrop-blur-sm">
            ...
            <CardContent className="px-4 sm:px-6">
              ...
              >
                ...
                <Button
                  type="submit"
                  className="w-full cursor-pointer dark:bg-[#15D3E0] hover:bg-[#13c4d1] text-white dark:text-black font-semibold py-3 sm:py-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-[1.02] h-12 sm:h-14"
                >
